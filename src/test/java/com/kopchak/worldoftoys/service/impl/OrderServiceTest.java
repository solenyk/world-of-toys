...
class OrderServiceTest {
    ...
    @Test
    public void updateOrderStatus_ExistentOrderId() throws InvalidOrderStatusException, MessageSendingException, OrderNotFoundException {
    ...
    public void updateOrderStatus_NonExistentOrderId_ThrowInvalidOrderException() throws MessageSendingException {
        ...
        assertException(OrderNotFoundException.class, invalidOrderExceptionMsg,
                () -> orderService.updateOrderStatus(ORDER_ID, statusDto));
