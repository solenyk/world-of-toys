...
VALUES (1000, 'до 1 року', 'do-1-roku'),
       (1001, 'від 1 до 3 років', 'vid-1-do-3-rokiv'),
       (1002, 'від 6 до 9 років', 'vid-6-do-9-rokiv');

INSERT INTO brand_category(id, name, slug)
VALUES (1000, 'CoComelon', 'сoсomelon'),
       (1001, 'Сurlimals', 'сurlimals'),
       (1002, 'Devilon', 'devilon'),
       (1003, 'Disney', 'disney'),
       (1004, 'comelon', 'сomelon');

INSERT INTO origin_category(id, name, slug)
VALUES (1000, 'Китай', 'china'),
       (1001, 'Україна', 'ukraine');

INSERT INTO product(id, name, slug, description, price, available_quantity, origin_id, brand_id)
VALUES (1001, 'Лялька Клаймбер', 'lyalka-klaymber',
        'Ця іграшка обєднує інноваційний дизайн та розвиваючий функціонал, що сприяє розвитку навичок у дітей. Вона створює захоплюючий світ уяви, розвиваючи логічне мислення та творчість. Іграшка безпечна, енергоефективна і сприяє розвитку спостережливості, уваги та винахідливості у дітей, забезпечуючи незабутні враження та навчальний досвід.',
        850, 1, 1000, 1000),
       (1002, 'Лялька Даринка', 'lyalka-darynka',
        'Ця іграшка обєднує інноваційний дизайн та розвиваючий функціонал, що сприяє розвитку навичок у дітей. Вона створює захоплюючий світ уяви, розвиваючи логічне мислення та творчість. Іграшка безпечна, енергоефективна і сприяє розвитку спостережливості, уваги та винахідливості у дітей, забезпечуючи незабутні враження та навчальний досвід.',
        900, 200, 1001, 1001),
       (1003, 'Лялька Русалочка', 'lyalka-rusalochka',
        'Ця іграшка обєднує інноваційний дизайн та розвиваючий функціонал, що сприяє розвитку навичок у дітей. Вона створює захоплюючий світ уяви, розвиваючи логічне мислення та творчість. Іграшка безпечна, енергоефективна і сприяє розвитку спостережливості, уваги та винахідливості у дітей, забезпечуючи незабутні враження та навчальний досвід.',
        550, 0, 1000, 1002),
       (1004, 'Пупсик Оксанка', 'pupsik_oksanka',
        'Ця іграшка обєднує інноваційний дизайн та розвиваючий функціонал, що сприяє розвитку навичок у дітей. Вона створює захоплюючий світ уяви, розвиваючи логічне мислення та творчість. Іграшка безпечна, енергоефективна і сприяє розвитку спостережливості, уваги та винахідливості у дітей, забезпечуючи незабутні враження та навчальний досвід.',
        500, 150, 1000, 1003);
...
VALUES (1, 'lyalka-klaymber1.png', 'image/png', X'1F8B', 1001);
...
VALUES ('4c980930-16eb-41cd-b998-29d03118d67c', 1001, 2);